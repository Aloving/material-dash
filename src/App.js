...
const DefaultText = Cookies.get('cookie-text') || `{morning} {dayTime}! Меня зовут Дарья, сегодня у нас запланирован урок в {time}! Пожалуйста, проверьте микрофон, камеру, установлен ли браузер Google Сhrome. 
